There is a list of courses divided into topics.
One teacher is assigned to each course.
...
Each user has a personal account, which displays brief information about the user,
